...
plot(NULL, NULL, xlim = c(0.25, 0.5), ylim = c(0,1.2), main = "Prediction of Y(theta) conditional on 5 evauation points", cex.main = 1.5, cex.axis = 1.5, cex.lab = 1.5, xlab = "theta", ylab = "Y(theta)")
legend("top", lty = 1:1, bty = "n", cex = 1, legend = c("E[Y(theta)|theta_E]", "Prediction interval"), col = c("black","#66CCFF"))
...
#Probability that Y(theta) < a on grid points conditional the 5 evaluation points
for (i in 1:51){
...
plot(NULL, NULL, xlim = c(0.25, 0.5), ylim = c(0,0.3), xlab = "theta", ylab = "Pr{Y(theta)|theta_E < 0.30}", main = "Probability of Y(theta)<0.30 conditional on 5 evaluation points", cex.main = 1.5, cex.axis = 1.5, cex.lab = 1.5)
...
#mu_grid_c: conditional mean vector of the process at the 51 grid points conditional on the 6 evaluation points
...
plot(NULL, NULL, xlim = c(0.25, 0.5), ylim = c(0,1.2), main = "Prediction of Y(theta) conditional on 6 evauation points", cex.main = 1.5, cex.axis = 1.5, cex.lab = 1.5, xlab = "theta", ylab = "Y(theta)")
legend("top", lty = 1:1, bty = "n", cex = 1, legend = c("E[Y(theta)|theta_E]", "Prediction interval"), col = c("black","#66CCFF"))
legend(x = 0.3515, y = 1.115, pch = 4, bty = "n", cex = 1, legend = c("Evaluation points"), col = c("red"))
...
#Probability that Y(theta) < a on grid points conditional the 6 evaluation points
for (i in 1:51){
...
plot(NULL, NULL, xlim = c(0.25, 0.5), ylim = c(0,0.3), xlab = "theta", ylab = "Pr{Y(theta)|theta_E < 0.30}", main = "Probability of Y(theta)<0.30 conditional on 6 evaluation points", cex.main = 1.5, cex.axis = 1.5, cex.lab = 1.5)
...
print(max(cdf_t2))
print(cdf_t2[which(theta_grid == 0.25)])