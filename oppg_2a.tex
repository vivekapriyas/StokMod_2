In figure \ref{2afiveeval} a prediction of $Y(\theta)$, conditional on the five evaluation points given in the project description, as well as a $90\%$ prediction interval is shown.
